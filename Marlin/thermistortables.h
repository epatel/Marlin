...
const short temptable_8[][2] PROGMEM = {
   ...
   {81*OVERSAMPLENR, 224},
   {91*OVERSAMPLENR, 216},
   {101*OVERSAMPLENR, 210},
   {111*OVERSAMPLENR, 204},
   {121*OVERSAMPLENR, 198},
   {131*OVERSAMPLENR, 194},
   {141*OVERSAMPLENR, 189},
   {151*OVERSAMPLENR, 185},
   {161*OVERSAMPLENR, 181},
   {171*OVERSAMPLENR, 178},
   {181*OVERSAMPLENR, 174},
   {191*OVERSAMPLENR, 171},
   {201*OVERSAMPLENR, 168},
   {211*OVERSAMPLENR, 165},
   {221*OVERSAMPLENR, 162},
   {231*OVERSAMPLENR, 160},
   {241*OVERSAMPLENR, 157},
   {251*OVERSAMPLENR, 155},
   {261*OVERSAMPLENR, 152},
   {271*OVERSAMPLENR, 150},
   {281*OVERSAMPLENR, 148},
   {291*OVERSAMPLENR, 146},
   {301*OVERSAMPLENR, 144},
   {311*OVERSAMPLENR, 142},
   {321*OVERSAMPLENR, 140},
   {331*OVERSAMPLENR, 138},
   {341*OVERSAMPLENR, 136},
   {351*OVERSAMPLENR, 135},
   {361*OVERSAMPLENR, 133},
   {371*OVERSAMPLENR, 131},
   {381*OVERSAMPLENR, 129},
   {391*OVERSAMPLENR, 128},
   {401*OVERSAMPLENR, 126},
   {411*OVERSAMPLENR, 125},
   {421*OVERSAMPLENR, 123},
   {431*OVERSAMPLENR, 122},
   {441*OVERSAMPLENR, 120},
   {451*OVERSAMPLENR, 119},
   {461*OVERSAMPLENR, 117},
   {471*OVERSAMPLENR, 116},
   {481*OVERSAMPLENR, 114},
   {491*OVERSAMPLENR, 113},
   {501*OVERSAMPLENR, 111},
   {511*OVERSAMPLENR, 110},
   {521*OVERSAMPLENR, 108},
   {531*OVERSAMPLENR, 107},
   {541*OVERSAMPLENR, 106},
   {551*OVERSAMPLENR, 104},
   {561*OVERSAMPLENR, 103},
   {571*OVERSAMPLENR, 102},
   {581*OVERSAMPLENR, 100},
   {591*OVERSAMPLENR, 99},
   {601*OVERSAMPLENR, 98},
   {611*OVERSAMPLENR, 96},
   {621*OVERSAMPLENR, 95},
